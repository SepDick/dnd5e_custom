...
export class EnchantmentData extends foundry.abstract.DataModel {
   ...
   */
  get enchantments() {
    return this.item.effects.filter(ae => ae.getFlag("dnd5e_custom", "type") === "enchantment");
  }
  ...
  static availableEnchantments(item) {
    ...
    return item.effects.filter(e => {
      if ( (e.getFlag("dnd5e_custom", "type") !== "enchantment") || e.isAppliedEnchantment ) return false;
      const { min, max } = e.getFlag("dnd5e_custom", "enchantment.level") ?? {};
