...
export default class WeaponData extends ItemDataModel.mixin(
  ...
  get _typeCriticalThreshold() {
    return this.parent?.actor?.flags.dnd5e_custom?.weaponCriticalThreshold ?? Infinity;
  }
  ...
  get proficiencyMultiplier() {
    ...
    const improvised = (this.type.value === "improv") && !!actor.getFlag("dnd5e_custom", "tavernBrawlerFeat");
