...
export default class TokenDocument5e extends SystemFlagsMixin(TokenDocument) {
   ...
   */
  get hasDynamicRing() {
    if ( game.release.generation < 12 ) return !!this.getFlag("dnd5e_custom", "tokenRing.enabled");
  ...
  get subjectPath() {
    ...
    const subject = this.getFlag("dnd5e_custom", "tokenRing")?.textures?.subject;
  ...
  _onDelete(options, userId) {
    ...
    const origin = this.actor?.getFlag("dnd5e_custom", "summon.origin");
